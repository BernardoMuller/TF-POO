...
private ConjuntoTransportes conjuntoTransportes=new ConjuntoTransportes();
    ...
    public GUI() {
        ...
        formSalvarDados=new FormSalvarDados(this, conjuntoEspaconaves, conjuntoTransportes, conjuntoPortos);
        formMostrarDados=new FormMostrarDados(this,conjuntoTransportes);
        formCarregarDados=new FormCarregarDados(this,conjuntoEspaconaves, conjuntoTransportes, conjuntoPortos);
